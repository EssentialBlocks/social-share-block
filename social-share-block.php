...
function create_block_social_block_init() {
	...
	if ( ! file_exists( $script_asset_path ) ) {
		throw new Error(
			'You need to run `npm start` or `npm run build` for the "social-share-block/social-share-block" block first.'
		);
	}
  ...
  wp_enqueue_style(
    ...
    register_block_type( 'social-share-block/social-share-block', array(
