...
function create_block_social_share_block_init()
{
	...
	wp_register_style(
		...
		array('fontpicker-default-theme', 'fontpicker-matetial-theme', 'essential-blocks-hover-css'),
	...
	wp_register_style(
		...
		$style_css,
		array('fontawesome-frontend-css', 'essential-blocks-animation', 'essential-blocks-hover-css'),
