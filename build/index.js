...
var RenderProfileIcons = function RenderProfileIcons(_ref) {
  ...
  var container = profileStyles.container,
      ...
      iconStyle = profileStyles.iconStyle; // Generates class names for profile icons

  var generateCssClassNames = function generateCssClassNames(icon) {
    // Show original icons if custom color is false
    var colorClass = !customColor ? "".concat(icon, "-original") : "";
    var hoverClass = hoverAnimation ? "hvr-".concat(hoverAnimation) : "";
    return "".concat(colorClass, " ").concat(hoverClass);
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("a", {
      className: "profile-icon-wrapper ".concat(generateCssClassNames(profile.icon)),
      href: profile.link,
      style: iconWrapper
...
RenderProfileIcons.propTypes = {
  profileStyles: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.shape({
    container: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.object.isRequired,
    iconWrapper: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.object.isRequired,
    iconStyle: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.object.isRequired
  }),
  profiles: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.array.isRequired,
  customColor: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.bool,
  hoverAnimation: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.string
};
/* harmony default export */ __webpack_exports__["default"] = (RenderProfileIcons);
...
/*!**************************!*\
  !*** ./src/constants.js ***!
  \**************************/
/*! exports provided: ICON_SHAPE, ICON_ALIGN, BORDER_TYPES, HOVER_ANIMATION */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HOVER_ANIMATION", function() { return HOVER_ANIMATION; });
var __ = wp.i18n.__;
var ICON_SHAPE = [{
  label: __("Rounded"),
  value: "rounded"
...
var HOVER_ANIMATION = [{
  ...
  label: __("Wobble To Bottom Right"),
  value: "wobble-to-top-right"
}, {
  label: __("Wobble To Top Right"),
  ...
  label: __("Grow Shadow"),
  value: "grow-shadow"
}, {
  label: __("Float Shadow"),
  value: "float-shadow"
}, {
  label: __("Glow"),
  value: "glow"
}, {
  label: __("Shadow Radial"),
  value: "shadow-radial"
}, {
  label: __("Box Shadow Outset"),
  value: "box-shadow-outset"
}, {
  label: __("Box Shadow Inset"),
...
/* harmony import */ var _RenderProfileIcons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./RenderProfileIcons */ "./src/RenderProfileIcons.js");
...
var Edit = /*#__PURE__*/function (_Component) {
  ...
  function Edit() {
    ...
    _defineProperty(_assertThisInitialized(_this), "componentDidMount", function () {
      var profilesString = _this.props.attributes.profilesString || "";

      var profiles = _this.getProfilesList();

      _this.props.setAttributes({
        profiles: profiles,
        profilesString: profilesString
      });
    });

    _defineProperty(_assertThisInitialized(_this), "generateProfileString", function (profiles) {
      ...
      var profilesString = "";
      profiles.map(function (profile) {
        profilesString = profilesString + "".concat(profile.icon, " ").concat(profile.link, ",");
    ...
    _defineProperty(_assertThisInitialized(_this), "onProfilesAdd", function (profiles) {
      var profilesString = _this.generateProfileString(profiles);
    ...
    _defineProperty(_assertThisInitialized(_this), "getProfile", function (item) {
      item = item.split(" ");
      var profile = {};
      profile.icon = item[0];
    ...
    _defineProperty(_assertThisInitialized(_this), "getProfilesList", function () {
      var profiles = [];
      var profilesString = _this.props.attributes.profilesString;
      var profilesList = profilesString ? profilesString.split(",") : [];
      profilesList.length && profilesList.map(function (item) {
        return profiles.push(_this.getProfile(item));
      });
      return profiles;
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function () {
      ...
      var profiles = attributes.profiles,
          ...
          boxHOffset = attributes.boxHOffset,
          boxVOffset = attributes.boxVOffset,
          ...
          profilesString = attributes.profilesString,
          ...
          iconSpacingUnit = attributes.iconSpacingUnit,
      ...
      var profileStyles = {
        container: {
          ...
          fontSize: "".concat(fontSize || 32).concat(fontSizeUnit),
          justifyContent: iconAlign,
          background: containerBackground
        },
        iconWrapper: {
          display: "flex",
          // ? Add this line to fix hover.css icon displacement issue
          ...
          marginRight: "".concat(iconSpacing || 8).concat(iconSpacingUnit),
          padding: "".concat(iconPadding || 32).concat(iconPaddingUnit),
          border: "".concat(borderSize || 0, "px  ").concat(borderType, " ").concat(borderColor || "#000000"),
          boxShadow: "".concat(boxHOffset || 0, "px ").concat(boxVOffset || 0, "px ").concat(shadowBlur || 0, "px ").concat(shadowSpread || 0, "px ").concat(boxShadowColor || "#000000")
        },
        iconStyle: {
          fontWeight: "normal",
          textShadow: "".concat(textHOffset || 0, "px ").concat(textVOffset || 0, "px ").concat(shadowRadius || 0, "px ").concat(textShadowColor || "#000000")
        }
      };
      return [isSelected && /*#__PURE__*/React.createElement(_inspector__WEBPACK_IMPORTED_MODULE_0__["default"], {
        attributes: attributes,
        setAttributes: setAttributes,
        onProfilesAdd: _this.onProfilesAdd,
        getProfilesList: _this.getProfilesList
      }),
      /*#__PURE__*/
      //Edit view Here
      React.createElement("div", {
        className: "eb-social-container"
      }, /*#__PURE__*/React.createElement(_RenderProfileIcons__WEBPACK_IMPORTED_MODULE_1__["default"], {
        profiles: profiles,
        customColor: customColor,
        profileStyles: _objectSpread(_objectSpread({}, profileStyles), {}, {
          display: profilesString ? "block" : "none"
        }),
        hoverAnimation: hoverAnimation
      }), /*#__PURE__*/React.createElement("p", {
        style: {
          display: profilesString ? "none" : "block"
        }
      }, "Add Icon"))];
    });
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["registerBlockType"])("block/social", {
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])("Social", "block"),
...
/* harmony import */ var _util_social_profiles_DealSocialProfiles__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../util/social-profiles/DealSocialProfiles */ "./util/social-profiles/DealSocialProfiles.js");
/* harmony import */ var _util_social_profiles_IconList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../util/social-profiles/IconList */ "./util/social-profiles/IconList.js");
...
var Inspector = function Inspector(_ref) {
  var attributes = _ref.attributes,
      ...
      onProfilesAdd = _ref.onProfilesAdd,
      getProfilesList = _ref.getProfilesList;
  var profiles = attributes.profiles,
      fontSize = attributes.fontSize,
      iconSpacing = attributes.iconSpacing,
      iconAlign = attributes.iconAlign,
  ...
  return /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["InspectorControls"], {
    ...
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Social Setting")
  }, /*#__PURE__*/React.createElement(_util_social_profiles_DealSocialProfiles__WEBPACK_IMPORTED_MODULE_4__["default"], {
    iconList: _util_social_profiles_IconList__WEBPACK_IMPORTED_MODULE_5__["default"],
    profiles: getProfilesList(),
    onProfileAdd: function onProfileAdd(profiles) {
      return onProfilesAdd(profiles);
    }
  })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["PanelBody"], {
    ...
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Icon Shape")
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["ButtonGroup"], null, _constants__WEBPACK_IMPORTED_MODULE_3__["ICON_SHAPE"].map(function (item) {
    ...
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Alignment"),
    value: iconAlign,
    options: _constants__WEBPACK_IMPORTED_MODULE_3__["ICON_ALIGN"],
    ...
    onClick: function onClick(iconSpacingUnit) {
      return setAttributes({
        iconSpacingUnit: iconSpacingUnit
      });
    }
  }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["RangeControl"], {
    ...
    onChange: function onChange(newValue) {
      return setAttributes({
        iconPadding: newValue
      });
    },
    min: 0,
    max: 100
  }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["ToggleControl"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Custom Colors"),
    checked: customColor,
  ...
  })), customColor && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__["PanelColorSettings"], {
    ...
    colorSettings: [{
      ...
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Container Background")
    }]
  }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["PanelBody"], {
    ...
    value: borderType,
    options: _constants__WEBPACK_IMPORTED_MODULE_3__["BORDER_TYPES"],
    ...
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Hover"),
    initialOpen: false
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["SelectControl"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Hover Animation"),
    value: hoverAnimation,
    options: _constants__WEBPACK_IMPORTED_MODULE_3__["HOVER_ANIMATION"],
    onChange: function onChange(newValue) {
      return setAttributes({
    ...
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Text Shadow"),
    initialOpen: false
  }, /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_8__["default"], {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Shadow Color"),
    ...
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])("Shadow Radius"),
    value: shadowRadius,
    allowReset: true,
    onChange: function onChange(newValue) {
      return setAttributes({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _RenderProfileIcons__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./RenderProfileIcons */ "./src/RenderProfileIcons.js");
/**
 * Internal dependencies
 */
...
var Save = function Save(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(_RenderProfileIcons__WEBPACK_IMPORTED_MODULE_0__["default"], {
    profiles: profiles,
    customColor: customColor,
